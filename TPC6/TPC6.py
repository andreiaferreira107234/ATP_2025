#Criar uma aplicação python(isto foi dado durante a aula prática 7) para guardar os registos de temperatura e precipitação aao longo de vários dias, materializando na variável tabMeteo1
